...
class Automacao(models.Model):
    ...
    planilha = models.FileField(upload_to='automacoes/planilhas/', null=True, blank=True, verbose_name="Arquivo Excel")
    
    # O AJUSTE ESTÁ AQUI: Adicionado null=True e blank=True
    ultima_execucao = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name="Última Atualização")
